...
{
    /// <summary>
    /// Credits‑menu exit button. Supplies sprite frames, click SFX, and hides the credits screen when released
    /// </summary>
    public class ButtonCreditsExit(Node parent) : ButtonComponent(parent)
    {
        ...
        // hide credits menu & play click sound
        public override void OnRelease()
        {
            var scene = Game1.GetScene();
            scene.FindNodeByName("creditsMenuBackground").SetActive(false);
            _soundEffect.Play();
        }
    }
}
...
/// <summary>
/// Settings‑menu Level4 button. Supplies sprite frames, click SFX, and requests a switch to Level4 on release
/// </summary>
public class Level4Button : ButtonComponent
{
    public Level4Button(Node parent) : base(parent) { }
    ...
    public override (Texture2D asset, AnimationData nonClicked, AnimationData clicked, SoundEffectInstance soundEffect) GetButtonData()
    {
        ...
        var clickedAnimation = new AnimationData(
            asset,
            new Rectangle[]{new Rectangle(256 * 11, 256 * 5, 256, 256)},
            0.2f,
            false,
            isUI: true
        );
        var normalAnimation = new AnimationData(
            asset,
            new Rectangle[]{new Rectangle(256 * 11, 256 * 4, 256, 256)},
            0.2f,
            false,
            isUI: true
        );
    ...
    {
        Game1.Instance.requestedLevelToChangeTo = LevelEnum.Level4;
        _soundEffect.Play();
    }
}
...
/// <summary>
/// Settings‑menu Level1 button. Supplies sprite frames, click SFX, and requests a switch to Level1 on release
/// </summary>
public class Level1Button : ButtonComponent
{
    
    public Level1Button(Node parent) : base(parent) { }
    ...
    public override (Texture2D asset, AnimationData nonClicked, AnimationData clicked, SoundEffectInstance soundEffect) GetButtonData()
    {
        ...
        var clickedAnimation = new AnimationData(
            asset,
            new Rectangle[]{new Rectangle(256 * 10, 256 * 5, 256, 256)},
            0.2f,
            false,
            isUI: true
        );
        var normalAnimation = new AnimationData(
            asset,
            new Rectangle[]{new Rectangle(256 * 10, 256 * 4, 256, 256)},
            0.2f,
            false,
            isUI: true
        );
